...
converts [Mapbox Studio formulas](https://www.mapbox.com/help/studio-manual-styles/#use-a-formula) into [expressions](https://docs.mapbox.com/mapbox-gl-js/style-spec/#expressions)
        ...
        'simplespec-to-gl-style': {
            ...
            description: md`
Converts GeoJSON styled with [\`simplestyle-spec\`](https://github.com/mapbox/simplestyle-spec/) to a Mapbox GL Style.
            `
        },
        'mapbox-gl-supported': {
    ...
    'Development Tools': {
        'mapbox-gl-js-mock': {
            ...
            description: md`
Is a [mock](https://en.wikipedia.org/wiki/Mock_object) of Mapbox GL JS.
            `
        },
        'mapbox-gl-inspect': {
                            ...
                            <div key={i} className="">
                                ...
                                {entries(plugins).map(([name, plugin], i) => (
                                    ...
                                    >
                                        ...
                                        <div className="color-gray color-gray-on-hover mb6">
                                            {plugin.description}
                                        </div>
